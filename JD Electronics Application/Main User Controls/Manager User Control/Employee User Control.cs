...
namespace Ekanayake_Printers_RMS.Main_User_Controls.Manager_User_Control
{
    public partial class Employee_User_Control : UserControl
    {
        ...
        SqlConnection conn = new SqlConnection(@"Data Source=THONKPAD;Initial Catalog=EKANAYAKE_PRINTERS_001;Integrated Security=True");
        ...
        private void btnCreate_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                conn.Open();
                SqlCommand cmd = new SqlCommand("Insert Into employeeTable(empID,userID,currentOccupation) values (@a, @b, @c)", conn);
                ...
                SqlCommand cmd2 = new SqlCommand("UPDATE userTable SET occupationINDEX=@value WHERE userID=@userID",conn);
        ...
        SqlConnection con = new SqlConnection(@"Data Source=THONKPAD;Initial Catalog=EKANAYAKE_PRINTERS_001;Integrated Security=True");
        SqlDataAdapter da;
                ...
                else
                {
                    ...
                    string connectionString = "YourConnectionString";
                        ...
                        string query = @"SELECT e.empID, e.userID, e.currentOccupation, e.currentWorkingBranch, e.companyExperiance,
                           u.fullName, u.uNIC, u.email, u.userAddress, u.tel, u.dob, u.createdDate
                    ...
                    //
                    //da = new SqlDataAdapter("Select * from employeeTable where nic = '" + textBox11.Text + "' AND employeeType = '" + comboBox2.SelectedIndex + "'",con);
                    //DataTable dt = new DataTable();
                    //da.Fill(dt);
                    //dataGridView1.DataSource = dt;
                }
