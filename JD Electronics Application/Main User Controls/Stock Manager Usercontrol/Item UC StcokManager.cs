...
namespace Ekanayake_Printers_RMS.Main_User_Controls
{
    public partial class Item_UC_StcokManager : UserControl
    {
        ...
        {
            SqlConnection con5 = new SqlConnection(" Data Source=THONKPAD;Initial Catalog=EKANAYAKE_PRINTERS_001;Integrated Security=True");
            con5.Open();
            try
            {
        ...
        private void button8_Click(object sender, EventArgs e)//add items
        {
            ...
            SqlConnection con2 = new SqlConnection(" Data Source=THONKPAD;Initial Catalog=EKANAYAKE_PRINTERS_001;Integrated Security=True");
            con2.Open();
            try
            {
        ...
        private void btnAdd_Click(object sender, EventArgs e)//add stock
        {
            ...
            SqlConnection con3 = new SqlConnection(" Data Source=THONKPAD;Initial Catalog=EKANAYAKE_PRINTERS_001;Integrated Security=True");
            con3.Open();
