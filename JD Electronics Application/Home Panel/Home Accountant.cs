...
namespace Ekanayake_Printers_RMS.Home_Panel
{
    public partial class Home_Accountant : UserControl
    {
        ...
        {
            // Fill chart1
            using (SqlConnection con1 = new SqlConnection("Data Source=THONKPAD;Initial Catalog=EKANAYAKE_PRINTERS_001;Integrated Security=True"))
            {
            ...
            // Fill chart2
            using (SqlConnection con2 = new SqlConnection("Data Source=THONKPAD;Initial Catalog=EKANAYAKE_PRINTERS_001;Integrated Security=True"))
            {
            ...
            // Fill chart3
            using (SqlConnection con3 = new SqlConnection("Data Source=THONKPAD;Initial Catalog=EKANAYAKE_PRINTERS_001;Integrated Security=True"))
            {
