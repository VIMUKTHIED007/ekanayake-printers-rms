...
using Ekanayake_Printers_RMS.Main_User_Controls.Administrator_User_Control;
...
namespace Ekanayake_Printers_RMS.Home_Panel
{
    public partial class Home_Adminstrator : UserControl
    {
        ...
        private void GetLiveSession()
        {
            ...
            try
            {
                ...
                using (SqlConnection conn = new SqlConnection(connectionString))
                {
                    ...
                    if (dr1.Read() == true)
                    {
                        int currentUID = Convert.ToInt32(dr1["userID"]);
                        ...
                        try
                        {
                            ...
                            {
                                setData.Parameters.Add("@user_ID", SqlDbType.Int).Value = currentUID;
        ...
        private void HomeAdminPanel_Paint(object sender, PaintEventArgs e)
        {
