using Ekanayake_Printers_RMS.Main_User_Controls;
using Ekanayake_Printers_RMS.Main_User_Controls.Accountant_UC;
using Ekanayake_Printers_RMS.Main_User_Controls.Cashier_UC;
using Ekanayake_Printers_RMS.Main_User_Controls.Manager_User_Control;
using Ekanayake_Printers_RMS.Main_User_Controls.Worker_UC;
using System;
...
namespace Ekanayake_Printers_RMS.Home_Panel
{
    public partial class Home_Accountant : UserControl
    {
            ...
            try
            {
                ...
                using (SqlConnection conn = new SqlConnection(connectionString))
                {
                    ...
                    if (dr1.Read() == true)
                    {
                        ...
                        try
                        {
                            string querySetName = "SELECT * FROM userTable WHERE userID = @user_ID";
        ...
        {
            // Fill chart1
            using (SqlConnection con1 = new SqlConnection("Data Source=LAPTOP-2956U5GC\\SQLEXPRESS;Initial Catalog=EKANAYAKE_PRINTERS_001;Integrated Security=True;Encrypt=True;TrustServerCertificate=True"))
            {
            ...
            // Fill chart2
            using (SqlConnection con2 = new SqlConnection("Data Source=LAPTOP-2956U5GC\\SQLEXPRESS;Initial Catalog=EKANAYAKE_PRINTERS_001;Integrated Security=True;Encrypt=True;TrustServerCertificate=True"))
            {
            ...
            // Fill chart3
            using (SqlConnection con3 = new SqlConnection("Data Source=LAPTOP-2956U5GC\\SQLEXPRESS;Initial Catalog=EKANAYAKE_PRINTERS_001;Integrated Security=True;Encrypt=True;TrustServerCertificate=True"))
            {
        ...
        private void HomeAccountanUC_Paint(object sender, PaintEventArgs e)
        {
