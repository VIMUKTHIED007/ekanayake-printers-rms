using Ekanayake_Printers_RMS.Home_Panel;
...
namespace Ekanayake_Printers_RMS.Dashboard
{
    public partial class Accountant_Dashboard : Form
    {
        ...
        private void GetOpenSession()
        {
            ...
            try
            {
                ...
                using (SqlConnection conn = new SqlConnection(connectionString))
                {
                    ...
                    if (dr1.Read() == true)
                    {
                        ...
                        {
                            // Session Data Gathering Error(Section_2) - silently handled
                        }
            ...
            {
                // Session Data Gathering Error(Section_1) - silently handled
            }
        ...
        private void saveSession()
        {
                    ...
                    if (dr1.Read() == true)
                    {
                        ...
                        try
                        {
                            ...
                            using (SqlCommand setUID = new SqlCommand(sessionQuery, conn))
                            {
                                ...
                                setUID.Parameters.AddWithValue("@user_ID", Convert.ToInt32(CurrentUserID));
                        ...
                        {
                            // Session Data Gathering Error(Section_Final_2) - silently handled
                        }
            ...
            {
                // // MessageBox.Show("Session Data Gathering Error(Section_Final_1) : " + ex);
        ...
        private void Accountant_Dashboard_Load(object sender, EventArgs e)
        {
