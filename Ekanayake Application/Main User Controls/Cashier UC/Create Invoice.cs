...
namespace Ekanayake_Printers_RMS.Main_User_Controls.Cashier_UC
{
    public partial class Create_Invoice : UserControl
    {
        ...
        private string connectionString = "Data Source=LAPTOP-2956U5GC\\SQLEXPRESS;Initial Catalog=EKANAYAKE_PRINTERS_001;Integrated Security=True;Encrypt=True;TrustServerCertificate=True";
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            {
                connection.Open();
                SqlCommand cmd = new SqlCommand("SELECT totalAmount FROM BillESIMATE WHERE estimateID = @EstimateID", connection);
                cmd.Parameters.AddWithValue("@EstimateID", textBox17.Text);
