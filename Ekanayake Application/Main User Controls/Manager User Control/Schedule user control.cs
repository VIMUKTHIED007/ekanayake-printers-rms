...
namespace Ekanayake_Printers_RMS.Main_User_Controls
{
    public partial class Schedule_user_control : UserControl
    {
        ...
        {
            connection = new SqlConnection(" Data Source=LAPTOP-2956U5GC\\SQLEXPRESS;Initial Catalog=EKANAYAKE_PRINTERS_001;Integrated Security=True;Encrypt=True;TrustServerCertificate=True");
        }
